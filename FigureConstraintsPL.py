# -*- coding: utf-8 -*-
"""
Code for plot  the constraints of PBH assuming Power-Law.
...
Mc4=RT.opentxt("listfile/P-L4.txt"," ")[0]
f4=RT.opentxt("listfile/P-L4.txt"," ")[1]
Mc27=RT.opentxt("listfile/P-L27.txt"," ")[0]
f27=RT.opentxt("listfile/P-L27.txt"," ")[1]
Mc22=RT.opentxt("listfile/P-L22.txt"," ")[0]
f22=RT.opentxt("listfile/P-L22.txt"," ")[1]
