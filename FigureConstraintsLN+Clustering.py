# -*- coding: utf-8 -*-
"""
Code for plot  the constraints of PBH assuming Log-Normal with clustering.
...
Mc10=RT.opentxt("listfile/LN06Cl10.txt",' ')[0]
f10=RT.opentxt("listfile/LN06Cl10.txt",' ')[1]

Mc06=RT.opentxt("listfile/LN06.txt",' ')[0]
f06=RT.opentxt("listfile/LN06.txt",' ')[1]

Mc100=RT.opentxt("listfile/LN06Cl100.txt",' ')[0]
f100=RT.opentxt("listfile/LN06Cl100.txt",' ')[1]

plt.fill_between(Mc06,f06,1, color='mediumpurple',alpha=0.4)
plt.plot(Mc06,f06,'indigo',label="$\\zeta=1$")
...
plt.savefig("Plots/constraintsLNCl.pdf", bbox_inches='tight')
